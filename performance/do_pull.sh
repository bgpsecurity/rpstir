...
echo "update apki_metadata set rootdir=\"${APKI_ROOT}/trunk/performance/REPOSITORY\";" | mysql $APKI_DB -u mysql
${APKI_ROOT}/trunk/rsync_aur/rsync_pull.sh rsync_perf.config > perf_output
