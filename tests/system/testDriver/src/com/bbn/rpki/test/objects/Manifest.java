...
public class Manifest extends CMS {
	...
	public Manifest(CA_Object parent) {
		...
		this.outputfilename = REPO_PATH + parent.getSIA_path()
				+ Util.b64encode_wrapper(parent.getCertificate().ski) + ".mft";
	...
	protected EE_cert getEECert() {
		if (eeCert == null) {
			...
			eeCert = new EE_cert(parent, parent.getValidityStartTime(),
					parent.getValidityEndTime(), "Manifest-EE",
					parent.getSIA_path() + "EE-" + manNum + "/",
					IPRangeList.IPV4_EMPTY, IPRangeList.IPV6_EMPTY,
