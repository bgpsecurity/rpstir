...
public abstract class AbstractAction implements XMLConstants {
	...
	enum ActionType {
		allocate, allocateROA, chooseCacheCheckTask
	}
	 ...
	 * 
	 * @param actionContext
	 *            Provides context for linking together cross references
	 ...
	 *            TODO
	 */
	public abstract void execute(EpochEvent executionEpoch,
			TypescriptLogger logger);
	 ...
	 * @return
	 */
	public abstract void addExecutionTime(EpochEvent epochEvent,
