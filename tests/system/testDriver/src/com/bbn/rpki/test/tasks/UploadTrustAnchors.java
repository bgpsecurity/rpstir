...
public class UploadTrustAnchors extends UploadFiles {
	 ...
	 */
	@Override
	protected com.bbn.rpki.test.tasks.TaskFactory.Task reallyCreateTask(
			String relativeTaskName) {
		File rootDir = model.getRepositoryRoot(relativeTaskName);
		return new Task(relativeTaskName, rootDir,
				new ExtensionHandler.ExtensionFilter("cer"));
	}
