...
public class AuthInfoPane extends ExtnFieldBasePane 
{
    String myType;
    RsyncPane rsyncPane;

  public AuthInfoPane(String type) {
     super("Authority Information Access", RuleEditorData.PROHIBIT, type, false);
     myType = type;
  }
  ...
  public int createRule(Member m) 
    {
    m.name.write("Authority Information Access");
    ...
    for (int i = 0; rsyncPane.done < num; rsyncPane.done++, i++)
        ...
        ta.objid.write(ExtensionsStatic.id_ad_caIssuers);
