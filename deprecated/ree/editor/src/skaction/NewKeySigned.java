...
import crlv2.*;
import asn.*;
public class NewKeySigned extends AsnSequence
    {
    public NewKeySignedToBeSigned toBeSigned = new NewKeySignedToBeSigned();
    ...
    public NewKeySigned set(NewKeySigned frobj)
        {
