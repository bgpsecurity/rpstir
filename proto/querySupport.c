...
int checkValidity(char *ski, unsigned int localID,
				  scm *scmp, scmcon *connect) {
  int status;
...
static int pathnameDisplay (scmsrcha *s, int idx1, char* returnStr)
{
...
static int displaySNList (scmsrcha *s, int idx1, char* returnStr)
{
...
static int displayFlags (scmsrcha *s, int idx1, char* returnStr)
{
...
QueryField *findField (char *name)
{
  int i;
