...
/*
 * TODO: this function is duplicated from signCMS.c, due to dependencies on
 * build-order (libroa cannot be linked in cg/tools). When we refactor, this
 * function ought to be removed entirely.  
 */

static const char *signCMSBlob(
    struct CMSBlob *cms,
