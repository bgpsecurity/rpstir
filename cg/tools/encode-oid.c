 ...
 * 
 * KEVIN BURNETT Software Engineer Strategic Partner Engineering Group
 * 
 * 01 Nov 1999
 * 
 * It is used here under the assumption that, as it was published as sample
 * code, it is intended for free public use. 
 */
    ...
    char *asn1Buf)
{
    ...
    do
    {
        ...
        {
            /*
             * Do this the 3rd-nth time through the main loop for every
             * integer element in the OID. 
             */
    ...
    if ((i <= 3) && (err == 0))
    {
        err = ERR_INVALID_IDENTITY;
        printf
            ("LdapOid2Asn1Id: LDAP OIDs must contain at least 3 elements.\n");
    }
...
/*
 * This handles Asn1Ids with a length of 127 or less. NW4&5 Asn1Ids seem to be 
    ...
    char *oidBuf)
{
    ...
    while (i < length)
    {
        ...
        /*
         * Make sure we have enough space for the next series of: a delimeter
         * char, an unsigned long decimal, and a null terminator. 
         */
        ...
        {
            /*
             * Multiply the result of last time through the loop by 128, and
             * then add the low bits to it. 
             */
            value = (0x80L * value) + (cur[i++] & (0x7F));
        }

        /*
         * This is the last part of this element, so multiply and add one
         * final time. 
         */
