...
/* May 22 2006 839U  */
/* May 22 2006 GARDINER added description of masks in char_table */
/* May 15 2006 837U  */
/* May 15 2006 GARDINER fixed level in pointed-to object in _dup_casn */
/* May 10 2006 836U  */
/* May 10 2006 GARDINER removed _asn_of; added optional verbose map_string */
/* Apr 21 2006 835U  */
/* Apr 21 2006 GARDINER fixed clearing */
/* Apr 20 2006 834U  */
/* Apr 20 2006 GARDINER cleaned up eject, & _clear_casn, removed _clear_of */
/* Mar 30 2006 833U  */
/* Mar 30 2006 GARDINER corrected test for defined BOOLEAN */
/* Feb 15 2006 830U  */
/* Feb 15 2006 GARDINER changed return from inject_casn & insert_casn */
/* Feb  9 2006 829U  */
/* Feb  9 2006 GARDINER fixed problem with CHOICE after absent OPTIONAL/DEFAULTs */
/* Apr 25 2005 828U  */
/* Apr 25 2005 GARDINER added inject, eject and member */
/* Mar 16 2005 827U  */
/* Mar 16 2005 GARDINER added ifdef for REALs */
/* Mar 10 2005 826U  */
/* Mar 10 2005 GARDINER corrected enforcement of DER for Reals */
/* Feb  9 2005 825U  */
...
/* Aug  5 2004 798U  */
/* Aug  5 2004 GARDINER created _readvsize() */
/* Aug  5 2004 797U  */
/* Aug  5 2004 GARDINER fixed DEFAULT cases in read_casn() */
/* Aug  3 2004 795U  */
/* Aug  3 2004 GARDINER changed err_struct to casn_err_struct */
/* Aug  3 2004 794U  */
/* Aug  3 2004 GARDINER corrected levels and linkages in insert_casn() */
/* Aug  2 2004 793U  */
/* Aug  2 2004 GARDINER fixed insert_casn to keep level in [0] item */
/* Jul 29 2004 791U  */
/* Jul 29 2004 GARDINER fixed stuff_ofs() */
/* Jul 29 2004 789U  */
/* Jul 29 2004 GARDINER added stuff_ofs() */
/* Jul 23 2004 787U  */
/* Jul 22 2004 GARDINER changed _check_filled and added more at top level */
/* Jul 21 2004 786U  */
/* Jul 21 2004 GARDINER corrected _set_all_lths */
/* Jul 15 2004 782U  */
/* Jul 15 2004 GARDINER fixed copy_of to handle enumerated items */
/* Jul 14 2004 780U  */
/* Jul 14 2004 GARDINER changed clear_casn; fixed filling of err_struct.asn_map_string */
/* Jul 13 2004 779U  */
/* Jul 13 2004 GARDINER revised next_of; fixed bug in _match_casn re CHOICEs */
/* Jul  8 2004 777U  */
...
/* Apr 15 2004 759U  */
/* Apr 15 2004 GARDINER changed to make decode_casn take no length; fixed insert_casn */
/* Apr  1 2004 753U  */
/* Apr  1 2004 GARDINER added _fill_upward() */
/* Apr  1 2004 752U  */
/* Apr  1 2004 GARDINER added defense against writing to first & only member of OF */
/* Mar 31 2004 750U  */
/* Mar 31 2004 GARDINER fixed insert_casn, _copy_of, _write_casn */
/* Mar 30 2004 748U  */
/* Mar 30 2004 GARDINER fixed index_casn */
/* Mar 30 2004 747U  */
/* Mar 30 2004 GARDINER made filling go up; fixed _stuff_string for various problems */
/* Mar 25 2004 744U  */
/* Mar 25 2004 GARDINER fixed warnings; added _check_filled */
/* Mar 25 2004 743U  */
...
int _calc_lth(uchar **cpp)
    {
    uchar *c = *cpp;
    int tmp, lth;

    if (*c == ASN_INDEF_LTH) return -1;
...
2. FOR all items in the structure at this level
        IF it's an OF
            Find the end of the OF chain
            Count the number of struct casn in the basic struct
            Make that many struct casns at the end of the chain
            Copy the first one into there
...
5.      IF at an OF OR in  SET, reset struct casn ptr
...
**/
	...
	if ((flags & ASN_EXPLICIT_FLAG) ||
	    ...
	    else ansr = curr_casnp->type;
	    if ((curr_casnp->type != ASN_ANY &&
                tag != (((curr_casnp->flags & ASN_EXPLICIT_FLAG))?
                ansr: curr_casnp->tag)) ||
                (nbytes && (did += explicit_extra) + lth > nbytes))
		return _casn_obj_err(curr_casnp, ASN_MATCH_ERR) - did;
	    }
	ansr = -1;
