...
CONFIG_GET_HELPER_DEREFERENCE(CONFIG_LOG_RETENTION, size_t)
CONFIG_GET_HELPER(CONFIG_RPKI_STATISTICS_DIR, char)
CONFIG_GET_HELPER(CONFIG_RPKI_RTR_USER, char)
CONFIG_GET_HELPER(CONFIG_RPKI_RTR_GROUP, char)
CONFIG_GET_HELPER(CONFIG_RPKI_RTR_USER, struct passwd)
CONFIG_GET_HELPER(CONFIG_RPKI_RTR_GROUP, struct group)
